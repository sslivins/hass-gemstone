...
import pytest
from pygemstone import DeviceState, HomeGroup, Pattern
...
@pytest.fixture
def folder_patterns(
    gemstone_pattern: Pattern, gemstone_pattern_alt: Pattern
) -> list[MagicMock]:
    """List returned by client.folder_patterns(page=1)."""
    fp1 = MagicMock(name="FolderPattern1")
    fp1.pattern = gemstone_pattern
    fp2 = MagicMock(name="FolderPattern2")
    fp2.pattern = gemstone_pattern_alt
    return [fp1, fp2]
